...
public class TimestampBasedPartitioner extends DefaultPartitioner{
	...
	public String encodePartition(JobContext context, AdLogOutput output) {
        long outfilePartitionMs = EtlMultiOutputFormat.getEtlOutputFileTimePartitionMins(context) * 60000L;
        return ""+DateUtils.getPartition(outfilePartitionMs, Long.valueOf(output.getTimestamp()), outputDateFormatter.getZone());
    } 
